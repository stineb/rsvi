...
## Load Data
Preprocessed data (subset for homogeneous sites, filtered by quality and merged with flue data and )
```{r}
 # Shortcut N2:
...
Includes temperature, APAR, and select only 5 vegetation classes
...
Includes results for each site 
